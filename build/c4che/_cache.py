...
CFLAGS_PYEMBED = ['-march=nocona', '-mtune=haswell', '-ftree-vectorize', '-fPIC', '-fstack-protector-strong', '-fno-plt', '-O3', '-fdebug-prefix-map==/usr/local/src/conda/-', '-fdebug-prefix-map==/usr/local/src/conda-prefix', '-fuse-linker-plugin', '-ffat-lto-objects', '-flto-partition=none', '-flto', '-fwrapv', '-O3']
CFLAGS_cshlib = ['-fPIC']
COMPILER_CC = 'gcc'
COMPILER_CXX = 'g++'
CPPPATH_ST = '-I%s'
...
CXXFLAGS_PYEMBED = ['-march=nocona', '-mtune=haswell', '-ftree-vectorize', '-fPIC', '-fstack-protector-strong', '-fno-plt', '-O3', '-fdebug-prefix-map==/usr/local/src/conda/-', '-fdebug-prefix-map==/usr/local/src/conda-prefix', '-fuse-linker-plugin', '-ffat-lto-objects', '-flto-partition=none', '-flto', '-fwrapv', '-O3']
...
EXAMPLE_DIRECTORIES = ['stats', 'udp-client-server', 'tutorial', 'traffic-control', 'tcp', 'energy', 'routing', 'realtime', 'ipv6', 'wireless', 'naming', 'socket', 'matrix-topology', 'error-model', 'udp']
...
INCLUDES_PYEMBED = ['/home/darshandv/anaconda3/include/python3.6m']
INFODIR = '/usr/local/share/info'
INT64X64_USE_128 = 1
LIBDIR = '/usr/local/lib'
LIBEXECDIR = '/usr/local/libexec'
LIBPATH_PYEMBED = ['/home/darshandv/anaconda3/lib/python3.6/config-3.6m-x86_64-linux-gnu', '/home/darshandv/anaconda3/lib']
LIBPATH_ST = '-L%s'
LIB_BOOST = []
...
NS3_EXECUTABLE_PATH = ['/home/darshandv/CS/ACN/Implementation-of-ECN-Plus-in-ns3/build/src/fd-net-device', '/home/darshandv/CS/ACN/Implementation-of-ECN-Plus-in-ns3/build/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-linux-gnu/5', '/home/darshandv/CS/ACN/Implementation-of-ECN-Plus-in-ns3/build/lib']
...
PYO = 1
PYTAG = 'cpython-36'
PYTHON = ['/home/darshandv/anaconda3/bin/python']
PYTHONARCHDIR = '/usr/local/lib/python3.6/site-packages'
PYTHONDIR = '/usr/local/lib/python3.6/site-packages'
PYTHON_CONFIG = ['/home/darshandv/anaconda3/bin/python3.6-config']
PYTHON_VERSION = '3.6'
...
cfg_files = ['/home/darshandv/CS/ACN/Implementation-of-ECN-Plus-in-ns3/build/ns3/config-store-config.h', '/home/darshandv/CS/ACN/Implementation-of-ECN-Plus-in-ns3/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
