...
CFLAGS_PYEMBED = ['-fno-strict-aliasing', '-g', '-fdebug-prefix-map=/build/python2.7-l1RrwO/python2.7-2.7.14=.', '-fstack-protector-strong', '-g', '-fwrapv', '-O2']
CFLAGS_PYEXT = ['-fno-strict-aliasing', '-g', '-fdebug-prefix-map=/build/python2.7-l1RrwO/python2.7-2.7.14=.', '-fstack-protector-strong', '-g', '-fwrapv', '-O2']
CFLAGS_cshlib = ['-fPIC']
COMPILER_CC = 'gcc'
COMPILER_CXX = 'g++'
CPPPATH_ST = '-I%s'
...
CXXFLAGS_PYEMBED = ['-fno-strict-aliasing', '-g', '-fdebug-prefix-map=/build/python2.7-l1RrwO/python2.7-2.7.14=.', '-fstack-protector-strong', '-g', '-fwrapv', '-O2']
CXXFLAGS_PYEXT = ['-fno-strict-aliasing', '-g', '-fdebug-prefix-map=/build/python2.7-l1RrwO/python2.7-2.7.14=.', '-fstack-protector-strong', '-g', '-fwrapv', '-O2', '-fvisibility=hidden', '-Wno-array-bounds']
...
DEFINES_ST = '-D%s'
DEFINE_COMMENTS = {'HAVE_SYS_IOCTL_H': '', 'HAVE_IF_NETS_H': '', 'HAVE_SIGNAL_H': '', 'HAVE_SYS_TYPES_H': '', 'PYTHONDIR': '', 'INT64X64_USE_128': '', 'HAVE_DIRENT_H': '', 'HAVE_STDINT_H': '', 'HAVE_SQLITE3': '', 'HAVE_LIBXML2': '', 'HAVE_NET_ETHERNET_H': '', 'HAVE_PYEXT': '', 'HAVE_SYS_STAT_H': '', 'HAVE_PACKET_H': '', 'HAVE_INTTYPES_H': '', 'HAVE_STDLIB_H': '', 'HAVE_PTHREAD_H': '', 'HAVE_PYTHON_H': '', 'HAVE___UINT128_T': '', 'HAVE_PYEMBED': '', 'PYTHONARCHDIR': '', 'HAVE_GTK': '', 'HAVE_GETENV': '', 'HAVE_RT': '', 'HAVE_IF_TUN_H': '', 'HAVE_SYS_INT_TYPES_H': '', 'HAVE_UINT128_T': ''}
DEST_BINFMT = 'elf'
DEST_CPU = 'x86_64'
DEST_OS = 'linux'
...
ENABLE_GSL = None
ENABLE_GTK = '-pthread -I/usr/include/gtk-3.0 -I/usr/include/at-spi2-atk/2.0 -I/usr/include/at-spi-2.0 -I/usr/include/dbus-1.0 -I/usr/lib/x86_64-linux-gnu/dbus-1.0/include -I/usr/include/gtk-3.0 -I/usr/include/gio-unix-2.0/ -I/usr/include/mirclient -I/usr/include/mircore -I/usr/include/mircookie -I/usr/include/cairo -I/usr/include/pango-1.0 -I/usr/include/harfbuzz -I/usr/include/pango-1.0 -I/usr/include/atk-1.0 -I/usr/include/cairo -I/usr/include/pixman-1 -I/usr/include/freetype2 -I/usr/include/libpng16 -I/usr/include/gdk-pixbuf-2.0 -I/usr/include/libpng16 -I/usr/include/glib-2.0 -I/usr/lib/x86_64-linux-gnu/glib-2.0/include -lgtk-3 -lgdk-3 -lpangocairo-1.0 -lpango-1.0 -latk-1.0 -lcairo-gobject -lcairo -lgdk_pixbuf-2.0 -lgio-2.0 -lgobject-2.0 -lglib-2.0\n'
...
EXAMPLE_DIRECTORIES = ['udp-client-server', 'tutorial', 'udp', 'naming', 'tcp', 'routing', 'error-model', 'matrix-topology', 'socket', 'realtime', 'stats', 'traffic-control', 'wireless', 'ipv6', 'energy']
...
INCLUDES_GTK = ['/usr/include/gtk-3.0', '/usr/include/at-spi2-atk/2.0', '/usr/include/at-spi-2.0', '/usr/include/dbus-1.0', '/usr/lib/x86_64-linux-gnu/dbus-1.0/include', '/usr/include/gio-unix-2.0/', '/usr/include/mirclient', '/usr/include/mircore', '/usr/include/mircookie', '/usr/include/cairo', '/usr/include/pango-1.0', '/usr/include/harfbuzz', '/usr/include/atk-1.0', '/usr/include/pixman-1', '/usr/include/freetype2', '/usr/include/libpng16', '/usr/include/gdk-pixbuf-2.0', '/usr/include/glib-2.0', '/usr/lib/x86_64-linux-gnu/glib-2.0/include']
...
NS3_EXECUTABLE_PATH = ['/home/darshan/ACN/ns-allinone-3.29/ns-3.29/build/src/fd-net-device', '/home/darshan/ACN/ns-allinone-3.29/ns-3.29/build/src/tap-bridge']
...
VERSION = '3.29'
WITH_PYBINDGEN = '/home/darshan/ACN/ns-allinone-3.29/pybindgen-0.17.0.post58+ngcf00cc0'
WL_SONAME_SUPPORTED = True
cfg_files = ['/home/darshan/ACN/ns-allinone-3.29/ns-3.29/build/ns3/config-store-config.h', '/home/darshan/ACN/ns-allinone-3.29/ns-3.29/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
